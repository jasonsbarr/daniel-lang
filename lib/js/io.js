...
const { STDOUT, makeFunction, makeModule } = require("../../src/runtime.js");
...
if (typeof window === "undefined") {
  ...
  EOL = window.navigator.platform.toLowerCase().startsWith("win")
    ? "\r\n"
    : "\n";
}
...
const print = (input) => STDOUT.write(printStr(input));

const println = (input) => STDOUT.write(printStr(input)) + EOL;
